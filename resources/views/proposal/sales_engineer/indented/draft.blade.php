                        ...
                        <div class="row">
                            <div class="col-lg-12 col-lg-pull-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input class="form-control" id="main_company" name="to" placeholder="To" value="{{ $indented_proposal->customer_id != '' ? $indented_proposal->customer->name : '' }}">
                                        <br>
                                        <textarea name="to_address" id="" class="form-control" placeholder="Address">{{ $indented_proposal->customer_id != '' ? $indented_proposal->customer->address : '' }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input name="sold_to" class="form-control" id="OfficeSold" placeholder="Sold To" value="{{ $indented_proposal->branch_id != '' ? $indented_proposal->branch->name : '' }}">
                                        <br>
                                        <textarea name="sold_to_address" class="form-control" placeholder="Address"> {{ $indented_proposal->branch_id != '' ? $indented_proposal->branch->address : '' }} </textarea>
                                    </div>
                                </div>
